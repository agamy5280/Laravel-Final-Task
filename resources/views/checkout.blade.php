...
<!-- Breadcrumb End -->
    ...
    <!-- Checkout Start -->
    <div class="container-fluid">
        <form method="post" action="{{url('addOrder')}}" id="orderForm" enctype="multipart/form-data">
            @csrf
        <div class="row px-xl-5">
            <div class="col-lg-8">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" placeholder="+123 456 789" name="mobileNum">
                        </div>
                        <div class="col-md-6 form-group">
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom">
                        ...
                        <div class="d-flex justify-content-between">
                            <p>{{ $prod['name'] }}</p>
                            <p>${{ $prod['price'] - ( $prod['price'] * $prod['discount'] ) }}</p>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="bg-light p-30">
                        ...
                        <button class="btn btn-block btn-primary font-weight-bold py-3" id="add-btn" type="submit" form="orderForm" value="Submit">Place Order</button>
                    </div>
                </div>
            </div>
        </div>
