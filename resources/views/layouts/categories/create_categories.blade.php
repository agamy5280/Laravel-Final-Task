...
<div class="content-wrapper" style="padding: 50px">
    <form method="POST" action="{{ url('admin/categories') }}" id="form-add" enctype="multipart/form-data">
        @csrf
        <h1>Add Category</h1>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Name:</label>
            <input type="text" class="form-control" name="name" id="exampleFormControlInput1" placeholder="Electronics" style="width: 400px;">
        </div>
        <div class="mb-3">
